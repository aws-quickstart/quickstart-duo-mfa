...
:partner-product-name: Duo MFA for AWS Directory Service 
...
:partner-company-name: Duo Security
:doc-month: May
:doc-year: 2021
...
:aws-contributors: Nagmesh Kumar, AWS ___ team
:quickstart-contributors: Dave May, Troy Ameigh, AWS Quick Start team
